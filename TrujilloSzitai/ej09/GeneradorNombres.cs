...
namespace ej09
{
	class GeneradorNombres
	{
		...
		{
			rFirstName = new Random(42);
			rLastname = new Random(rFirstName.Next());
		}

		public string[] GenerarNombre()
		{
			string[] results = new string[2];
			results[0] = _firstName[rFirstName.Next(_firstName.Length)];
			results[1] = _lastName[rLastname.Next(_lastName.Length)];
			return results;
		}
		static Random rFirstName;
		static Random rLastname;
